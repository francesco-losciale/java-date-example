...
class JavaTimePackageTest {
    ...
    @Test
    void when_SummerTime_And_Doing_Date_Calculation_Using_Utc_Dates_Then_Result_Is_Not_Different_From_Doing_Them_With_Local_DateTime() {
        OffsetDateTime utcDateTime = OffsetDateTime.parse("2019-08-27T10:00:00.000Z");
        LocalDateTime localDateTime = convertToLondonLocalDateTime(utcDateTime);
